...
{og}{head_extra}  <link rel="icon" type="image/png" sizes="32x32" href="assets/favicon-32.png">
  ...
  <script>try{{if(localStorage.getItem('pp_age_ok')==='1')document.documentElement.classList.add('age-ok')}}catch(e){{}}</script>
</head>
<body>
          ...
          <div class="owner-info">
            ...
            <div class="owner-cards">
              ...
              <div class="card">
                ...
                <p>Reach out to Cody personally for business inquiries, large bulk orders, wholesale, and partnerships.</p>
              </div>
            </div>
